...
class Constants {
  ...
  final val cstContainerType1 = "ContainerWithFormhWidgetsAndWithoutSubContainer"
  final val cstContainerType2 = "ContainerWithFormWidgetsAndWitSubContainers"
  final val cstContainerType3 = "ContainerWithOnlySubContainers"
  ...
  final val cstDescription = "description"
  ...
  final val cstHorizontalForm = "horizontalForm"
  ...
  final val cstInfo = "3-info"
  final val cstInlineForm = "inlineForm"
  ...
  final val cstMenuBar = "com.balsamiq.mockups::MenuBar"
  final val cstMessage = "Message"
  final val cstMessageFileNotFound = "Messages File not found "
  ...
  final val cstReporting = "reporting"
  ...
  final val cstComponent = "component"
  final val cstTemplateField = "field"
  final val cstTemplateId = "templateId"
  ...
  final val cstW = "w"
  final val cstWarning = "2-warning"
